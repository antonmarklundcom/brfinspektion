...
| D6 | **SERP/competitor check** on top commercial terms (data gap). | Final titles/meta (Phase 4 polish) | Provisional titles per strategy.md; record SERP findings in repo before finalizing. | Anton or executing model w/ web access |
